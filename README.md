...
```
cd existing_repo
git remote add origin https://gitlab.tugraz.at/CF2A2BC8BA507771/fcss2025-fpg3.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.tugraz.at/CF2A2BC8BA507771/fcss2025-fpg3/-/settings/integrations)
